...
;;;***

;;;### (autoloads nil "kubernetes-core" "kubernetes-core.el" (0 0
;;;;;;  0 0))
;;; Generated autoloads from kubernetes-core.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "kubernetes-core" '("kubernetes-")))
...
;;;***

;;;### (autoloads nil "kubernetes-el-tramp" "kubernetes-el-tramp.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from kubernetes-el-tramp.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "kubernetes-el-tramp" '("kubernetes-tramp-" "get--tramp-file-path")))
...
;;;***

;;;### (autoloads nil "kubernetes-persistentvolumeclaims" "kubernetes-persistentvolumeclaims.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from kubernetes-persistentvolumeclaims.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "kubernetes-persistentvolumeclaims" '("kubernetes-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "kubernetes-process" '("kubernetes-")))
